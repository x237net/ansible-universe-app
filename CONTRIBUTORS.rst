...
The *universe.app* project is released under the licensing terms of the MIT
...
included within the *universe.app* project but does not fall under the terms
stated above.
...
The below-signed are contributors to the project named *universe.app*. Each
